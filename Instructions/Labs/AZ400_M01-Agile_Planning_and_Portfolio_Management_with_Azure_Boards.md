...
1.  If needed, start a web browser, navigate to your Azure DevOps organization, and open the **Agile Planning and Portfolio Management with Azure Boards** project you generated in the previous exercise. 
...
1.  Click the **Project settings** label located in the lower left corner of the page to open the **Project settings** page.
...
1.  At the top of the **Boards** pane, select the **Iterations** tab and then click **+ Select iterations**. 
1.  Select **Agile Planning and Portfolio Management with Azure Boards\Sprint 1** and click **Save and close**. Note that this first sprint has already passed. This is because the demo data generator is designed to build out project history so that this sprint occurs in the past.
    ...
    > **Note**: The new team will use the same iteration schedule that's already in place for the other teams, but you could create a custom one if that is more suitable better for your organization.
...
1.  On the **Boards** panel, in the upper right corner, select the **Backlog items** entry and, in the dropdown list, select **Backlog items**.
...
1.  On the **Board** tab of the **PUL-Web** panel, drag the second work item named **As a customer,  I want to request new tutorials** from the **New** to the **Done** stage.
...
1.  On the **Board** tab of the **PUL-Web** pane, at the top of the pane, click **View as Backlog** to display the tabular form.
    ...
    > **Note**: You can use the second plus sign directly under the first to add a new task to the first backlog item.

1.  On the **Board** tab of the **PUL-Web** pane, in the upper left corner of the pane, click the second plus sign. This will display the **NEW TASK** panel.
...
1.  On the **Taskboard** tab of the **Sprints** view, in the toolbar, on the right hand side, select the **View options** symbol (directly to the left of the funnel icon) and, in the **View options** dropdown list, select the **Work details** entry.
    ...
    > **Note**: The current sprint has a pretty limited scope. There are two tasks in the **To do** stage. At this point, neither task has been assigned. The first one does not include the value of estimated work. 

1.  Hover with the mouse pointer over the area directly to the right of the **Unassigned** entry of rectangle representing the **Add page for most recent tutorial**. This should reveal a smaller rectangle where you can set the value of estimated work.
1.  Click the smaller rectangle where you can set the value of estimated work and, in the textbox, type **5**.
...
1.  Click the **Configure team settings** cogwheel icon (directly to the left of the funnel icon).
...
1.  On the **As a customer, I want to view new tutorials** panel, click **Save & Close**.
    ...
    > **Note**: The two tags are now visible on the card, with the **data** tag highlighted yellow as configured.
...
In this task, you will step through the process of creating dashbords and their core components.
...
1.  On the **Add a field to Product Backlog Item** panel, on the **Layout** tab, in the **Label** textbox, type **Ticket ID**, select the **Create a new group** option, in the **Group** textbox, type **PartsUnlimited**, and click **Add field**.
    ...
    > **Note**: Now that the customized process has been configured, let's switch the Agile Planning and Portfolio Management with Azure Boards project to use it. 
