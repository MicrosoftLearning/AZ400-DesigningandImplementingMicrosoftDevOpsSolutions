...
1.  Click on the deploy to Azure button. [![alt text][image]][hyperlink] This will automatically redirect you to the **Custom deployment** blade in the Azure portal.
