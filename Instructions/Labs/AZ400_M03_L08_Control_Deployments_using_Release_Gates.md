...
1. From the **eShopOnWeb** project in the Azure DevOps portal, in the vertical navigational pane, select **Pipelines** and then, within the **Pipelines** section, click **Releases**.
   > **Note**: If the **Releases** section is not visible, it is certainly because the **Disable creation of classic release pipelines** toggle is set to **On** under the **Project Settings** > **Pipelines** > **Settings** > **General** section.
